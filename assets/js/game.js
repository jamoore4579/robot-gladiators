...
//Game States
// "WIN" - Player robot has detected all enemy-robots
...
//console.log(playerName, playerAttack, player Health);
...
var fight = function(enemyNames) {
    ...
    if (promptFight === "fight" || promptFight === "FIGHT") {
        //Subtract the value pf 'playerAttack' from the value of 'enemyHealth' 
